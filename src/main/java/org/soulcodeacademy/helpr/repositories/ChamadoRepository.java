...
public interface ChamadoRepository extends JpaRepository<Chamado, Integer> {
    List<Chamado> findByStatus(StatusChamado status); // Filtrar os chamanos de acordo com status
    List<Chamado> findByCliente(Cliente cliente); // Filtrar os chamados de um cliente
    List<Chamado> findByFuncionario(Funcionario funcionario); // Filtrar os chamados por funcionarios
